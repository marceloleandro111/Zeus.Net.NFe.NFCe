...
namespace NFe.Danfe.Nativo.NFCe
{
    public class DanfeNativoNfce
    {
        ...
        private void GerarNfCe(Graphics graphics)
        {
            ...
            if (_logo != null)
            {
                new RedimensionaImagemPara(new AdicionarImagem(g, _logo, _x, _y), 50, 50).Desenhar();
            }
...
#region cabeçalho
            ...
            _y = EscreverLinhaTitulo(g, razaoSocialEmitente, 12, larguraLogo, _x, _y, larguraLinha);

            string cnpjEmitente = CnpjEmitente();

            _y = EscreverLinhaTitulo(g, cnpjEmitente, tamanhoFonteTitulo, larguraLogo, _x, _y, larguraLinha);

            string enderecoEmitente = EnderecoEmitente();

            var alturaEndereco = EscreverLinhaTitulo(g, enderecoEmitente, tamanhoFonteTitulo, larguraLogo, _x, _y, larguraLinha);

            _y = alturaEndereco + 11;
            ...
            _y = EscreverLinhaTitulo(g, mensagemGoverno, 7, 0, _x, _y, larguraLinha);
...
#region preencher itens
            foreach (det detalhe in det)
            {
                ...
                if (valorDescontoItem > 0.0m)
                {
                    ...
                    descontoColuna.Desenhar(_x + 50, _y);
                    ...
                    int valorDescontoItemColunaX = ((_x + 246) + tituloColunaTotal) -
                ...
                if (valorAcrescimoItem > 0.0m)
                {
                    ...
                    acrescimoColuna.Desenhar(_x + 50, _y);
                    ...
                    int valorAcrescimoItemColunaX = ((_x + 246) + tituloColunaTotal) -
                ...
                if (valorDescontoItem > 0.0m || valorAcrescimoItem > 0.0m)
                {
                    ...
                    valorLiquidoTexto.Desenhar(_x + 50, _y);
                    ...
                    int valorLiquidoTotalTextoX = ((_x + 246) + tituloColunaTotal) -
            ...
            textoQuantidadeTotalItens.Desenhar(_x, _y);
            ...
            textoValorTotal.Desenhar(_x, _y);
            ...
            if (totalDesconto > 0)
            {
                ...
                textoValorAPagar.Desenhar(_x, _y);
            ...
            tituloFormaPagamento.Desenhar(_x, _y);
            ...
            foreach (pag pag in _nfe.infNFe.pag)
            {
                ...
                textoFormaPagamento.Desenhar(_x, _y);
